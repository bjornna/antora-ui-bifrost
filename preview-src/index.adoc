...
[horizontal]
[red]#Rødt varsel#:: Dersom STRATIFY score > 1, vil dette varsles med et rødt fall-ikon og teksten "Høy fallrisiko".

[yellow]#Gult varsel#:: Dersom STRATIFY score = 1, vil det varsles med et gult fall-ikon og teksten "Moderat fallrisiko".

[lime]#Grønt varsel#:: Dersom STRATIFY score = 0, vil det varsles med et grønt fall-ikon og teksten "Lav fallrisiko".
